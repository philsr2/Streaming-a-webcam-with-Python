...
I keep this new websockets server is a narrow lane, only my home IP can send to it.  Separate FW zones using Firewall-cmd makes it a dream to keep safe (ssh is limited to my FW's home zone too so my logs don't get clogged up with all the bot login attempts).
...
Things still to do:
  ...
  6  other things I haven't thought of yet (like TLS connections)
